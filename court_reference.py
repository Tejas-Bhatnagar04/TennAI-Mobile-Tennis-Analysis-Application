...
Code borrowed from https://github.com/avivcaspi/TennisProject
...
class CourtReference:
    ...
    def __init__(self):
        ...
        self.court = cv2.cvtColor(cv2.imread('court_configurations/court_reference2.png'), cv2.COLOR_BGR2GRAY)
    ...
    def build_court_reference(self):
        ...
        plt.imsave('court_configurations/court_reference2.png', court, cmap='gray')
        self.court = court
        return court
